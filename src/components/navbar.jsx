...
function Navbar({search,setSearch,handleInputChange}) {
  return (
    <nav className='p-6 navbarstyling flex justify-between shadow-lg shadow-purple-100'>
      <div>
        <h1 className='p-3 font-mono font-bold text-black indent-4 decoration-solid'>
          Hacker News
        </h1>
        <ul className='inline-flex p-3 text-xl gap-4 font-mono'>
      ...
      <div className='grid'>
        <a
          className='text-4xl pt-2 justify-self-end font-mono font-semibold text-black'
          href=''>
          login
        </a>
   
        {/* <button className='drop-shadow-xl rounded-lg shadow-lg shadow-purple-100 search-btn-navbar py-1'> */}
          <input
            className='rounded-lg text-center input-btn-navbar'
            type='text'
            value={search}
